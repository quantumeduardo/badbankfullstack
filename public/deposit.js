...
const handleChange = (event) =>{
  ...
  return (
   ...
   body={show ? (  
          ...
          Amount   
          <input type="number"  className="form-control" id="deposit"  placeholder = "$0.00" value= {amount} onChange={e => setAmount(Number(e.currentTarget.value))}/><br/>
